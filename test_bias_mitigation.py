...
class TestBiasMitigation(unittest.TestCase):
    ...
    def test_train_weighted_model(self):
        ...
        self.assertTrue(os.path.exists('visualizations/bias_mitigation/weighted_model_balanced_performance.png'))
    ...
    def test_fairness_constrained_optimization(self):
        ...
        # Verify that the plots were created
        self.assertTrue(os.path.exists('visualizations/bias_mitigation/fairness_constrained_convergence.png'))
        self.assertTrue(os.path.exists('visualizations/bias_mitigation/fairness_constrained_performance.png'))
