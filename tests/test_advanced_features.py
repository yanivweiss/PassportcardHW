...
# Ensure the src directory is in Python path to import modules
...
from src.enhanced_risk_scores import (
...
from src.advanced_modeling import select_features, temporal_cross_validation
from src.error_analysis import analyze_prediction_errors, create_regression_confusion_matrix, plot_error_heatmap
...
class TestErrorAnalysis(unittest.TestCase):
    ...
    def test_analyze_prediction_errors(self):
        ...
        self.assertIn('mean_abs_error', error_results['error_stats'], "MAE should be calculated")
        
        # Check for error distribution plot
        self.assertIn('error_distribution', error_results, "Error distribution should be calculated")
        
        # Check if the visualization was created
        self.assertTrue(os.path.exists('outputs/figures/error_distribution.png'), 
                       "Error distribution plot should be created")
